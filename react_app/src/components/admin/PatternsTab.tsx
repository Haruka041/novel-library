...
import {
  ...
  CircularProgress, Grid, Chip, IconButton, Dialog, DialogTitle,
  DialogContent, DialogActions, Table, TableBody, TableCell,
  TableContainer, TableHead, TableRow, Paper, Switch, FormControlLabel,
  Tooltip, Accordion, AccordionSummary, AccordionDetails, Select,
  MenuItem, FormControl, InputLabel
} from '@mui/material'
import {
  Add, Delete, Edit, PlayArrow, AutoAwesome, ExpandMore,
  Code, ContentCopy, CheckCircle, Error as ErrorIcon, Refresh
            ...
            {patterns.length === 0 ? (
              ...
              patterns.map((pattern) => (
                <TableRow key={pattern.id}>
                  ...
                  <TableCell>
                    <Typography variant="caption">
                      匹配: {pattern.match_count} | 成功: {pattern.success_count}
                    </Typography>
                  </TableCell>
                  <TableCell>
                    <Chip
